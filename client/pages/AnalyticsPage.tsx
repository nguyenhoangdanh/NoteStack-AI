...
import { ArrowLeft, BarChart3, TrendingUp, Users, FileText, Clock, Target } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Avg. Words/Note</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">With AI assistance</p>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Notes per week average</p>
              </div>
              <div className="text-center p-4 border rounded-lg">
