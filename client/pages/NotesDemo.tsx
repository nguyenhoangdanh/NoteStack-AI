  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiResponse = {
        ...
        role: "assistant" as const,
        content:
          "This is a demo response. In the full version, I would analyze your notes using AI and provide contextual answers with citations from your actual notes.",
        timestamp: Date.now(),
